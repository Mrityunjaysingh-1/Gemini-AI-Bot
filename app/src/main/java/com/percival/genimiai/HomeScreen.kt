...
@Composable
fun HomeScreen(uiState: HomeUiState = HomeUiState.Loading, onSenderClicked: (String, List<Uri>) -> Unit){
            ...
            Column {
                Row(modifier = Modifier.padding(vertical = 16.dp), verticalAlignment = Alignment.CenterVertically) {
                    ...
                    IconButton(onClick = {pickMediaLauncher.launch(PickVisualMediaRequest(ActivityResultContracts.PickVisualMedia.ImageOnly))
                        ...
                        Icon(imageVector = Icons.Default.AddCircle, contentDescription = "Add Images")
                    }
                    ...
                    IconButton(onClick = {
                        if (userQues.isNotBlank()) {
                            onSenderClicked(userQues, imageUris)
                        }
                    }) {
